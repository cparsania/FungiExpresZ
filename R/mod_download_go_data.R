...
download_go_data_ui <- function(id){
  ...
  tagList(
    br(),
    tags$h2("Download Gene Ontology Data" , style = "text-align:center; font-weight: bold;"),
    hr(),
    tags$div(fluidRow(
      column(width = 12,
...
# mod_download_go_data_ui("download_go_data_ui_1")
    
## To be copied in the server
# callModule(mod_download_go_data_server, "download_go_data_ui_1")
