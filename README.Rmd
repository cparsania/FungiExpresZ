...
Download pre-compiled binary of latest release [for MacOS (\*.tgz file)](https://github.com/cparsania/FungiExpresZ/releases/) and install it using command below.  
...
### 3.5 Run
  + Once installation complete successfully, it can be run using `FungiExpresZ::run_app()`
