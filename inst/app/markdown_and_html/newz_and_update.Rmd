...
FungiExpresZ can be installed as an R package and run on local computer. For local installation, please follow instruction on [Github](https://github.com/cparsania/FungiExpresZ#install)
