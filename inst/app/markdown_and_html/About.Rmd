...
In here, we have grouped samples by replicates]. File can be downloaded from [here](https://raw.githubusercontent.com/cparsania/FungiExpresZ/master/inst/app/cartoon_data/cartoon_sample_groups_by_cond.txt){target="_blank"}. 
