...
4.  [**\# top variable genes to show**]{.ul}
...
1.  [**Axis limits**]{.ul}: Click on \`set\` pops-up a text-box which allows users to set minimum and maximum values for X and Y axis.

2.  [**Trend line**]{.ul}**:** Buttons under this option allow turn on or off trend line.
...
3.  [**Color by**]{.ul}**:** Set color for the dots in the scatter plot.
...
4.  [**Transparency**]{.ul}**:** A slide-bar to adjust transparency of the dots.

5.  [**Point size**]{.ul}**:** A slide-bar to adjust size of the dots.
...
1.  [**Corr text color**]{.ul}**:** Select a color from the palettes or type-in color hex code (e.g. \#FF0000) or name (e.g. red) for the correlation values displayed in the plot.

2.  [**Font size**]{.ul}**: Corr text:** A slide-bar to adjust the size of the correlation values displayed in the plot.
...
1.  [**Number of colors**]{.ul}**:** A slide-bar to select number of colors the plot.

2.  [**Cluster variables**]{.ul}**:** Decides whether to cluster samples or not.
...
3.  [**Method**]{.ul}**:** Display correlation values either by square or circle.

4.  [**Type**]{.ul}**:** Display plot as **Full,** only **Upper half** or **Lower half**.

5.  [**Scale**]{.ul}**:** Adjust scale to map values to colors.
...
6.  [**Show corr value**]{.ul}**:** Decide whether to show correlation values in the plot.

7.  [**Font size**]{.ul}**: Corr text:** A slide-bar to adjust font size of the correlation values.

8.  [**Corr text color**]{.ul}**:** Select a color form the palette for the corr values.
...
1.  [**Fill by:**]{.ul} A variable choice to fill colors in the density curve.
...
2.  [**Separate by**]{.ul}**:** A variable choice to separate (or facet) plots.
...
3.  [**Transparency**]{.ul}**:** A slide-bar to adjust transparency of the plot.
...
3.  [**Bar position**]{.ul}**:** Adjust position of the bars in the histogram.
...
4.  [**Number of bins**]{.ul}**:** A numeric-input to adjust number of bins/bars to show in the histogram.

5.  [**Transparency**]{.ul}**:** A slide-bar to adjust transparency of the plot.
...
1.  [**Y-axis:**]{.ul} A variable choice to show values on Y-axis.
...
2.  [**Fill by**]{.ul}**:** A variable choice to fill colors in the joy-plot.
...
3.  [**Fill Choices**]{.ul}**:** Choices for Pre-defined color palette.

4.  [**Fill reverse**]{.ul}**:** Whether toreverse color scale.

5.  [**Color ridges**]{.ul}**:** Select a color from palette for ridges.

6.  [**Separate by**]{.ul}**:** A variable choice to separate (or facet) plots.
...
1.  [**X-axis**]{.ul}**:** A variable choice to show values on X-axis.
...
2.  [**Fill by**]{.ul}**:** A variable choice to fill colors in the box-plot.
...
3.  [**Separate by**]{.ul}**:** A variable choice to separate (or facet) plots.
...
4.  [**P-value:**]{.ul} Whether to show p-values between observation. User can choice between `t.test` or `wilcox.test` to calculate the pair-wise p-values.

5.  [**Dots**]{.ul}**:** Whether to overlay dots on top of box.

6.  [**Box transparency**]{.ul}: A slide-bar to adjust transparency of the each box.
...
2.  [**Fill by**]{.ul}**:** A variable choice to fill colors in the violin-plot.
...
5.  [**Show quantile**]{.ul}**:** For selected quantile values horizontal lines will be plotted within each violin.

6.  [**Transparency**]{.ul}: A slide-bar to adjust transparency of the each violin.
...
1.  [**X-axis:**]{.ul} A choice of variable to show in X-axis.

    -   **Genes:** genes will be plotted on X-axis.

    -   **Samples:** Samples will be plotted X-axis.

2.  [**Fill by:**]{.ul} A choice of variable to fill colors in bars.
...
3.  [**Select**]{.ul}**:** Choose colors from palette when "Fill by" selected to "Manual".

4.  [**Separate by**]{.ul}**:** A variable choice to separate (or facet) plots.
...
5.  [**Scale**]{.ul}**:** Adjust scale for multiple plots. Useful when plots are separated by one of the above variables.
...
1.  [**Select PCs**]{.ul}**:** Select any two principle components to plot them on the X and Y-axis.

2.  [**Display sample names**]{.ul}**:** Whether to show sample/variable names in the PCA plot.

3.  [**Dot size**]{.ul}**:** A slide-bar to adjust size of the dots displayed corresponding to each sample/variable in the PCA plot.

4.  [**Color by**]{.ul}**:** Choice of the variable to color dots displayed in the PCA plot.
...
5.  [**Select color**]{.ul}**:** Select a color from a palette if a choice for `color by` is `Identical`
...
1.  [**Color**]{.ul}**:** Choice of a variable to color lines in the line-plot.
...
2.  [**Separate by**]{.ul}**:** Choice of a variable to separate line plots.
...
3.  [**Scale**]{.ul}**:** Adjust scale for multiple plots. Useful when plots are separated by gene-groups.
...
4.  [**Line shape**]{.ul}**:** A slide-bar to adjust line shapes.

5.  [**Transparency**]{.ul}**:** A slide-bar to adjust transparency of the each line in the line-plot.

6.  [**Number of columns**]{.ul}**:** A numeric input to adjust the plot arrangement in columns. Useful when line-plots are separated/faceted by gene-groups.

7.  [**Point size**]{.ul}**:** A slide-bar to adjust size of the points in the line-plot.

8.  [**Line size**]{.ul}**:** A slide-bar to adjust size (width) of the each line in the line-plot.
...
1.  [**Row height**]{.ul}**:** A slide-bar to adjust the height of the each row in the heatmap.
2.  [**Column width**]{.ul}**:** A slide-bar to adjust the width of the each column in the heatmap.
...
1.  [**Ontology**]{.ul}**:** Select ontology type - Biological Process, Cellular Component, or Molecular Function - for enrichment analysis.

2.  [**Gene cluster**]{.ul}**:** Select a gene cluster for which GO enrichment analysis to be performed.

3.  [**View type**]{.ul}**:** Select a type of plot to visualize enriched GO terms. Choices are...
...
4.  [**Background Genes to GO mapping**]{.ul}**:** It allows user to select type of background data (Genes to GO mapping) to use for GO enrichment analysis.
...
5.  [**\# of minimum genes in a GO term**]{.ul}**:** User can restrict the GO enrichment output. Only those GO terms will be displayed, which has minimum number of genes more than cutoff value.

6.  [**\# of maximum genes in a GO term**]{.ul}**:** User can restrict the GO enrichment output. Only those GO terms will be displayed, which has maximum number of genes less than cutoff value.

7.  [***p-*****adjust**]{.ul}**:** Choice of methods to calculate adjusted *p-*value.
...
1.  [**X-axis**]{.ul}**:** Choice of a variable (Count or Gene Ratio) to show on X-axis.
2.  [**Color by**]{.ul}**:** Choice of a variable (*P-*value, *P-*adjust or *Q-*value) to color observations.
3.  [**Show terms**]{.ul}**:** Numeric input to show number of GO terms in the plot.\
...
1.  [**Font size: Node label**]{.ul}**:** A slide-bar to adjust font size of the labels to each node.
2.  [**Color by**]{.ul}**:** Choice of a variable to color GO-terms.
3.  [**Layout**]{.ul}**:** Select plot layout.
4.  [**Show terms**]{.ul}**:** A numeric input to show number of GO-terms.
...
1.  **Fon[t size Node label]{.ul}:** A slide-bar to adjust font size of the labels to each node.
2.  [**Layout**]{.ul}**:** Select plot layout.
3.  [**Show terms**]{.ul}**:** A numeric input to show number of GO-terms.
...
1.  [**Number of terms**]{.ul}**:** Number of terms to show in the plot.
2.  [**Line size**]{.ul}**:** A slide-bar to adjust the size of lines.
3.  [**Intersection size title**]{.ul}**:** A slide-bar to adjust font size of the Y-axis title - "**Intersection size".**
4.  [**Intersection size tick labels**]{.ul}**:** A slide-bar to adjust font size of the Y-axis tick labels.
5.  [**Set size**]{.ul}**:** Aslide-bar to adjust font size of the label "**Set size**".
6.  [**Point size**]{.ul}**:** A slide-bar to adjust point size in the plot.
7.  [**Set size tick labels**]{.ul}**:** A slide-bar to adjust the tick labels for the axis - "Set size".
8.  [**Set names**]{.ul}**:** A slide-bar to adjust font size of the set names.
9.  [**Numbers above bars**]{.ul}**:** A slide-bar to adjust font size for the number above bars.
10. [**Main bar color**]{.ul}**:** A choice of the color from a color palette for the main bars.
11. [**Sets bar color**]{.ul}: A choice of the color from a color palette for the set bars.
12. [**Matrix color:** A]{.ul} choice of the color from a color palette for the matrix.
...
1.  [**Select**]{.ul}**:** Choice of a color to presence of a gene in a GO-term.
2.  [**Show terms**]{.ul}**:** A numeric input to show number of terms in the plot.
3.  [**Flip axis**]{.ul}**:** Flip values between X and Y axis.
