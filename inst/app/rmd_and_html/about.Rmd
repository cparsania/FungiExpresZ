...
```{r go_dotplot , out.width="80%" ,fig.cap="GO dotplot" }
knitr::include_graphics(c("_about_files/example_plots/go_dotplot.png"))
```

## GO barplot

```{r go_barplot , out.width="80%" ,fig.cap="GO barplot" }
...
```{r go_emapplot , out.width="80%" ,fig.cap="GO emapplot", out.extra='style="background-color: black; padding:1px;"' }
knitr::include_graphics(c("_about_files/example_plots/go_emapplot.png"))
```

## GO cnetplot

```{r go_cnetplot , out.width="80%" ,fig.cap="GO cnetplot " ,out.extra='style="background-color: black; padding:1px;"'}
knitr::include_graphics(c("_about_files/example_plots/go_cnetplot.png"))
```

## GO upsetplot

```{r Go_plot_3 , out.width="80%" ,fig.cap="GO upsetplot",out.extra='style="background-color: black; padding:1px;"' }
