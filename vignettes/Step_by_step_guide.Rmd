...
```{r , fig.cap="FIGURE 6: FungiExpresZ Scatter plot input panel" , out.width="100%"  }
...
```{r , fig.cap="FIGURE 7: FungiExpresZ Multi-scatter plot, CorrHeatBox, Density plot, Histogram, Joy plot, Box plot. Violin plot and PCA plot input panel" , out.width="100%"  }
...
```{r , fig.cap="FIGURE 9: FungiExpresZ Line plot input panel" , out.width="100%"  }
...
```{r , fig.cap="FIGURE 10: FungiExpresZ Heatmap inputs" , out.width="100%"  }
