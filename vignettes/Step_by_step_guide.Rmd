...
By default, all the observations / genes will be displayed in a scatter plot. Optionally, selecting gene group(s) allow you to show specific observations / genes in a scatter plot. 

**4) Plot** 

Hitting plot button will open up a plot panel containing resultant scatter plot and other plot settings. 
