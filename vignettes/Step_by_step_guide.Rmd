...
Selection of species is optional. However, selection of correct species is necessary to perform gene annotations and GO analysis. Once the selection of a species is made, in background FungiExpresZ matches row names of uploaded data to the database id of selected species. For the selected species, you can cross check your id with the database id from the sample id given below the species selection drop-down menu. 
